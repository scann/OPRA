...
<p>
    📸 Вместе мы разберёмся в тонких особенностях оптимизации производительности Redux-приложений. Пристегни ремни — будет интересно!
</p>
<br>
<p>
...
11. Перейди в браузер и открой страницу по адресу [http://localhost:3000](http://localhost:3000/);
12. Открой **`Chrome Dev Tools`** и перейди на вкладку **`console`**, там должен быть выведен массив, и не должно быть каких-либо ошибок.
