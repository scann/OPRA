<h1 align="center">
<a href="https://lectrum.io" target="_blank" rel="noopener noreferrer"> <img src="./static/favicon/favicon-woodsmoke.svg" alt="Lectrum favicon" width="25" /></a> O.P.R.A. — Optimizing Performance of Redux Applications</h1>

<br>

<div align="center">
  <!-- Package version -->
    <img src="https://img.shields.io/github/package-json/v/lectrum/OPRA.svg?longCache=true&style=flat-square"
      alt="Package version" />
  <!-- Last commit -->
    <img src="https://img.shields.io/github/last-commit/lectrum/OPRA.svg?longCache=true&style=flat-square"
      alt="Last commit" />
  <!-- Dependencies -->
    ...
    <tbody>
        <tr>
            <td>
                ...
                <p>
                    📸&nbsp;Вместе мы разберёмся в тонких особенностях оптимизации производительности Redux-приложений.
...
6. Склонируй и запусти этот проект: `git clone https://github.com/Lectrum/OPRA.git`;
7. Чтобы перейти в директорию с проекта, после клонирования выполни команду `cd OPRA`;
